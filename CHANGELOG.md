...
- `wgportal` role: add admin username and password support, update docker-compose volume paths,
  and create default config for wgportal service

## [1.5.5] - 2026-05-31

### Changed

- `docker` role: refine Docker task handling, only systemd supported.
